...
const ProductCardSlider3 = () => {
  return (
    <div className="container product-card-slider_2 third_container_hero_product">
      <div class="section-header-hero-page">
        <div class="title-wrapper">
          <div class="title-content">
            <h2 class="section-title">
              <span class="title-text">Bivouac Hiking </span>
            </h2>
          </div>
        </div>
        <a
          href="/en//////equipement-trail-running-occasion"
          class="see-all-link"
        >
          See all
          <svg
