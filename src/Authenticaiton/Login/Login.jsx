              ...
              <a href="/en/page/legals" className="login-footer-link">
                <div className="login-footer-item">
                  <svg className="login-footer-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M5.05029 5.05078L19.1924 19.1929" stroke="currentColor" strokeWidth="2"></path>
                  </svg>
              ...
              <a href="/en/page/cookies" className="login-footer-link">
                <div className="login-footer-item">
                  <svg className="login-footer-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16.4533 8.27063V3.9494C14.5606 3.9494 11.7102 2.64963 9.99994 1.49805C9.99994 1.49805 5.43928 3.9494 3.54663 3.938V11.999C3.54663 12.2612 4.0027 15.6019 10.0114 18.6233C10.0114 18.6233 16.4533 15.4081 16.4533 11.6455V8.01864" stroke="currentColor" strokeWidth="2" strokeMiterlimit="10"></path>
                  </svg>
